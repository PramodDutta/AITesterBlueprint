# AI Test Data Generation: Exercises

## Practice Goal

Use these exercises to turn the topic into QA-ready thinking and implementation steps.

### Focus Exercise: Synthetic data design lab

1. Generate payload ideas for an account-creation API from an OpenAPI spec.
2. List the edge cases required for a customer profile schema.
3. Design persona-based data for a new user, premium user, and fraud-risk user.
4. Create a validation checklist for AI-generated data before it enters automated tests.
